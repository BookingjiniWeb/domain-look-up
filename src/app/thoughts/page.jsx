...
const CEOThoughts = () => {
    ...
    return (
        <section className="relative z-50 w-full min-h-screen py-16 bg-gradient-to-b from-orange-50 via-white to-pink-50 flex flex-col">
            <h2 className="text-4xl font-extrabold text-center text-gray-800 mb-12 tracking-tight">
                Thoughts Shared by Everyone
            </h2>

            <div className="flex-1 w-full overflow-y-auto px-6 md:px-12 pb-12">
